...
#ifndef ZEPHYR_DRIVERS_MISC_BT81X_BT81X_REFERENCE_API_H_
#define ZEPHYR_DRIVERS_MISC_BT81X_BT81X_REFERENCE_API_H_
...
static inline void cmd_text(int16_t x,
			   ...
			   const char *s)
{
	bt81x_copro_cmd_text(x, y, font, options, s);
}
...
static inline void cmd_number(int16_t x,
			     ...
			     int32_t n)
{
	bt81x_copro_cmd_number(x, y, font, options, n);
}
...
#endif /* ZEPHYR_DRIVERS_MISC_BT81X_BT81X_REFERENCE_API_H_ */

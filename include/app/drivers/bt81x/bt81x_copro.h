...
/**
 * @file
 * @brief BT81X coprocessor functions
 */

#ifndef ZEPHYR_DRIVERS_MISC_BT81X_BT81X_COPRO_H_
#define ZEPHYR_DRIVERS_MISC_BT81X_BT81X_COPRO_H_
 ...
 * @defgroup bt81x_copro BT81x co-processor
 ...
 * @p options is zero. @ref BT81X_OPT_CENTERX centers the text horizontally,
 * @ref BT81X_OPT_CENTERY centers it vertically. @ref BT81X_OPT_CENTER centers
 * the text in both directions. @ref BT81X_OPT_RIGHTX right-justifies the text,
 ...
 * @ref BT81X_OPT_CENTERX centers the text horizontally, @ref BT81X_OPT_CENTERY
 * centers it vertically. @ref BT81X_OPT_CENTER centers the text in both
 * directions. @ref BT81X_OPT_RIGHTX right-justifies the text, so that the @p x
 ...
 * If @ref BT81X_OPT_SIGNED is given, the number is treated as signed, and
...
#endif /* ZEPHYR_DRIVERS_MISC_BT81X_BT81X_COPRO_H_ */
